...
export async function build({ root = ROOT } = {}) {
  ...
  const html = template
    ...
    .replace("__BOOKLET_CODE__", () => [stageLabels, performanceCore, profiler, taskGroups, nav, sidebar, graph, modelLab, tracker, tree, idle, explorer, analyzer, tasks, ideas, overhead, palette, eyes, boot, workspace, music, planning, onboarding, booklet].join("\n"));
